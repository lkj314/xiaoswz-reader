...
| v0.2.7 | 6 | 修复点开章节真实崩溃（ReaderViewModel 构造单参化）+ 全局设置/关于页 | 崩溃靠 `adb logcat` 定位，非猜测 |
| v0.2.8 | 7 | 壳子重构（底部导航栏 书城/书架/设置 + 接入设置页）+ 本地书架（Room：收藏/进度记忆/续读） | 用户 USB 真机验证通过；**原 M3 的本地书架被提前并入** |
...
| ~~v0.2.5~~ | M2.5 阅读器壳子美化（菜单层/转场/设置面板/纸质衬线） | v0.2.5 ✅ |
