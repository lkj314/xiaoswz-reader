...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 35
        versionCode = 65
        versionName = "0.11.4" // 0.11.4·模块C（护眼显示）：新增蓝光过滤（暖色滤镜叠加，不拦截滚动）+ 连续阅读休息提醒（10/20/30/45/60 分钟可选，达阈值弹提醒不阻断阅读）；复用既有阅读主题（米纸/护眼绿/夜间/纯黑）。前置 0.11.3 听书TTS、0.11.2 核心去脆弱化。物理隔离、主站只读不变
